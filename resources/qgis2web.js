...
map.getView().fit([73626.475665, 9025240.495207, 671524.389954, 9421704.927664], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa del departamento de San Martin</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (95 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado para el curso de Cartografia y SIG<br />UPN-2025<br />Angela Jimena Quispe Puente';
            }
